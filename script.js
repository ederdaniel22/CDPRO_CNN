...
async function loadModel() {
    try {
        ...
        document.getElementById('prediction-result').innerText = 'Modelo carregado com sucesso.';
    } catch (error) {
...
async function predict() {
    if (!model) {
        alert('O modelo ainda nao foi carregado. Aguarde alguns segundos.');
        return;
    }
    ...
    try {
        ...
        document.getElementById('prediction-result').innerText = `Resultado: ${result} (Confianca: ${confidence}%)`;
    } catch (error) {
        console.error('Erro ao fazer a previsao:', error);
        document.getElementById('prediction-result').innerText = 'Erro ao fazer a previsao.';
    }
